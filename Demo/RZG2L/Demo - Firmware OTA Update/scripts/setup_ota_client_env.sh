...
THING_GROUP_NAME="g2l_fota_update_group"
...
log " Starting Ota Client (Greengrass) environment setup..."
...
configure_greengrass_core
deploy_nucleus_12_0_0
# create_systemd_service # to be commented
# start_greengrass_core  #to  be commented
verify_greengrass_status
print_versions

log "OTA Client setup complete with Greengrass Core"
